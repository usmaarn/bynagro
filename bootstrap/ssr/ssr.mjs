...
default_1((page) => createInertiaApp({
  ...
  resolve: (name) => resolvePageComponent(`./Pages/${name}.jsx`, /* @__PURE__ */ Object.assign({ "./Pages/Dashboard.jsx": () => import("./assets/Dashboard.f993fc49.mjs"), "./Pages/Home.jsx": () => import("./assets/Home.b42cc835.mjs") })),
  setup: ({
    App,
    props
  }) => {
